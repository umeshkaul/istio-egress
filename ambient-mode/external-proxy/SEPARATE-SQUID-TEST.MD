...
# test httpbin - as you can see it is redirected to httpbin
[shambu]ukaul in ~/Projects/istio-egress/ambient-mode/external-proxy on main ● λ k -n curl-client1 exec -it shell -- curl https://www.httpbin.org/ip
